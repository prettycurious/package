...
var formatBytes = require('pretty-bytes');
...
// const npmRegistryURL = 'https://tech.suitbim.com/verdaccio/' || 'https://registry.npmjs.org';\
const npmRegistryURL = require('./config.js').npmRegistryURL
...
function get$1(options) {
  return new Promise((accept, reject) => {
    const {isHttps,..._options} = options 
    if(isHttps){
      https.get(_options, accept).on('error', (error)=>{
        console.log(error)
        reject(error)
      });
    }else{
...
async function fetchPackageInfo(packageName, log) {
  ...
  const options = {
    ...
    isHttps: infoURL.indexOf('https:')!==-1
  };
  const res = await get$1(options);
...
async function getPackage(packageName, version, log) {
  ...
  const options = {
    ...
    hostname: hostname,
    path: pathname,
    isHttps: tarballURL.indexOf('https:')!==-1
  };
  const res = await get$1(options);
  if (res.statusCode === 200) {
...
function createIcon$1(Type, _ref) {
  ...
  return react.jsx(Type, _extends({
    css: {
      ...css,
...
function FileIcon(props) {
  return createIcon$1(GoFile, props);
}
function FileCodeIcon(props) {
  return createIcon$1(GoFileCode, props);
}
function FolderIcon(props) {
  return createIcon$1(GoFileDirectory, props);
}
...
function FolderViewer(_ref) {
  ...
  const {
    subdirs,
    files
  } = Object.keys(entries).reduce((memo, key) => {
    const {
      subdirs,
      files
    } = memo;
  ...
  subdirs.forEach(_ref2 => {
    ...
    rows.push(react.jsx("tr", {
      ...
      css: iconCellStyle
    }, react.jsx(FolderIcon, null)), react.jsx("td", {
      css: tableCellStyle
    }, react.jsx("a", {
      title: relName,
      href: href,
      css: linkStyle
    }, relName)), react.jsx("td", {
      css: tableCellStyle
    }, "-"), react.jsx("td", {
      css: typeCellStyle
    }, "-")));
  ...
  files.forEach(_ref3 => {
    ...
    rows.push(react.jsx("tr", {
      ...
      css: iconCellStyle
    }, contentType === 'text/plain' || contentType === 'text/markdown' ? react.jsx(FileIcon, null) : react.jsx(FileCodeIcon, null)), react.jsx("td", {
      css: tableCellStyle
    }, react.jsx("a", {
      title: relName,
      href: href,
  ...
  return react.jsx(ContentArea, null, react.jsx(ContentAreaHeaderBar, null, react.jsx("span", null, counts.join(', '))), react.jsx("table", {
    css: {
      width: '100%',
  ...
  }, react.jsx("thead", null, react.jsx("tr", null, react.jsx("th", null, react.jsx(visuallyHidden.VisuallyHidden, null, "Icon")), react.jsx("th", null, react.jsx(visuallyHidden.VisuallyHidden, null, "Name")), react.jsx("th", null, react.jsx(visuallyHidden.VisuallyHidden, null, "Size")), react.jsx("th", null, react.jsx(visuallyHidden.VisuallyHidden, null, "Content Type")))), react.jsx("tbody", null, rows)));
}
...
function CodeListing(_ref2) {
  ...
  return react.jsx("div", {
  ...
  }, react.jsx("tbody", null, lines.map((line, index) => {
    ...
    return react.jsx("tr", {
    ...
    }, react.jsx("span", null, lineNumber)), react.jsx("td", {
      id: "LC" + lineNumber,
      css: {
        paddingLeft: 10,
        paddingRight: 10,
      ...
      dangerouslySetInnerHTML: createHTML$1(line)
    })));
  }), !hasTrailingNewline && react.jsx("tr", {
    key: "no-newline"
  }, react.jsx("td", {
    css: {
      paddingLeft: 10,
...
function FileViewer(_ref3) {
  ...
  return react.jsx(ContentArea, null, react.jsx(ContentAreaHeaderBar, null, react.jsx("span", null, formatBytes(size)), react.jsx("span", null, language), react.jsx("span", null, react.jsx("a", {
  ...
  }, "View Raw"))), highlights ? react.jsx(CodeListing, {
    highlights: highlights
  }) : uri ? react.jsx(ImageViewer, {
    path: path,
    uri: uri
  }) : react.jsx(BinaryViewer, null));
}
if (process.env.NODE_ENV !== 'production') {
...
const buildId$1 = "df3ec76";
const globalStyles$1 = react.css(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteralLoose(["\n  html {\n    box-sizing: border-box;\n  }\n  *,\n  *:before,\n  *:after {\n    box-sizing: inherit;\n  }\n\n  html,\n  body,\n  #root {\n    height: 100%;\n    margin: 0;\n  }\n\n  body {\n    ", "\n    font-size: 16px;\n    line-height: 1.5;\n    overflow-wrap: break-word;\n    background: white;\n    color: black;\n  }\n\n  code {\n    ", "\n  }\n\n  th,\n  td {\n    padding: 0;\n  }\n\n  select {\n    font-size: inherit;\n  }\n\n  #root {\n    display: flex;\n    flex-direction: column;\n  }\n"])), fontSans, fontMono);

// Adapted from https://github.com/highlightjs/highlight.js/blob/master/src/styles/atom-one-light.css
const lightCodeStyles = react.css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteralLoose(["\n  .code-listing {\n    background: #fbfdff;\n    color: #383a42;\n  }\n  .code-comment,\n  .code-quote {\n    color: #a0a1a7;\n    font-style: italic;\n  }\n  .code-doctag,\n  .code-keyword,\n  .code-link,\n  .code-formula {\n    color: #a626a4;\n  }\n  .code-section,\n  .code-name,\n  .code-selector-tag,\n  .code-deletion,\n  .code-subst {\n    color: #e45649;\n  }\n  .code-literal {\n    color: #0184bb;\n  }\n  .code-string,\n  .code-regexp,\n  .code-addition,\n  .code-attribute,\n  .code-meta-string {\n    color: #50a14f;\n  }\n  .code-built_in,\n  .code-class .code-title {\n    color: #c18401;\n  }\n  .code-attr,\n  .code-variable,\n  .code-template-variable,\n  .code-type,\n  .code-selector-class,\n  .code-selector-attr,\n  .code-selector-pseudo,\n  .code-number {\n    color: #986801;\n  }\n  .code-symbol,\n  .code-bullet,\n  .code-meta,\n  .code-selector-id,\n  .code-title {\n    color: #4078f2;\n  }\n  .code-emphasis {\n    font-style: italic;\n  }\n  .code-strong {\n    font-weight: bold;\n  }\n"])));
...
function AppNavigation(_ref2) {
  ...
  if (filename === '/') {
    ...
    breadcrumbs.push(react.jsx(Link$1, {
      href: url + "/"
    }, packageName));
    let segments = filename.replace(/^\/+/, '').replace(/\/+$/, '').split('/');
  ...
  }, react.jsx("nav", null, breadcrumbs.map((item, index, array) => react.jsx(React.Fragment, {
    key: index
  }, index !== 0 && react.jsx("span", {
    css: {
      paddingLeft: 5,
      paddingRight: 5
    }
  }, "/"), index === array.length - 1 ? react.jsx("strong", null, item) : item)))), react.jsx(PackageVersionPicker, {
...
function PackageVersionPicker(_ref3) {
  ...
  }, react.jsx("label", null, "Version:", ' ', react.jsx("select", {
    name: "version",
  ...
  }, availableVersions.map(v => react.jsx("option", {
    key: v,
    value: v
  }, v)))));
}
function AppContent(_ref4) {
  ...
  return target.type === 'directory' ? react.jsx(FolderViewer, {
    path: target.path,
    details: target.details
  }) : target.type === 'file' ? react.jsx(FileViewer, {
...
function App$1(_ref5) {
  ...
  return react.jsx(React.Fragment, null, react.jsx(react.Global, {
  ...
  }, react.jsx(AppHeader, null)), react.jsx("div", {
    css: {
      maxWidth: maxContentWidth,
      padding: '0 20px',
      margin: '0 auto'
    }
  }, react.jsx(AppNavigation, {
    packageName: packageName,
    packageVersion: packageVersion,
    availableVersions: availableVersions,
    filename: filename
  ...
  }, react.jsx("p", null, react.jsx("span", null, "Build: ", buildId$1)), react.jsx("p", null, react.jsx("span", null, "\xA9 ", new Date().getFullYear(), " UNPKG")), react.jsx("p", {
    css: {
      fontSize: '1.5rem'
    }
  }, react.jsx("a", {
  ...
  }, react.jsx(TwitterIcon$1, null)), react.jsx("a", {
...
function MainTemplate({
  ...
  !GTAG_MEASUREMENT_ID ? null : createScript(`var s = document.createElement('script');
s.async = 'true';
s.src='https://www.googletagmanager.com/gtag/js?id=${GTAG_MEASUREMENT_ID}';
document.head.append(s);
window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());gtag('config', '${GTAG_MEASUREMENT_ID}');`), React.createElement('meta', {
    charSet: 'utf-8'
...
async function serveBrowsePage(req, res) {
  ...
  const content = createHTML(server$1.renderToString(React.createElement(App$1, data)));
  const elements = getScripts('browse', 'iife', globalURLs$1);
...
async function serveDirectoryBrowser(req, res, next) {
  ...
  serveBrowsePage$1(req, res, next);
}
...
async function findEntry$3(stream, filename) {
...
async function serveFileBrowser(req, res) {
  const stream = await getPackage(req.packageName, req.packageVersion, req.log);
  const entry = await findEntry$3(stream, req.filename);
  if (!entry) {
    return res.status(404).send(`Not found: ${req.packageSpec}${req.filename}`);
  }
  const details = {
...
async function findEntry$2(stream, filename) {
  // filename = /some/file/name.js
  return new Promise((accept, reject) => {
    let foundEntry = null;
    stream.pipe(tar.extract()).on('error', reject).on('entry', async (header, stream, next) => {
...
async function serveFileMetadata(req, res) {
  const stream = await getPackage(req.packageName, req.packageVersion, req.log);
  const entry = await findEntry$2(stream, req.filename);
  res.send(entry);
}
...
var _templateObject;
const buildId = "df3ec76";
const globalStyles = react.css(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  html {\n    box-sizing: border-box;\n  }\n  *,\n  *:before,\n  *:after {\n    box-sizing: inherit;\n  }\n\n  html,\n  body,\n  #root {\n    height: 100%;\n    margin: 0;\n  }\n\n  body {\n    ", "\n    font-size: 16px;\n    line-height: 1.5;\n    overflow-wrap: break-word;\n    background: white;\n    color: black;\n  }\n\n  code {\n    ", "\n    font-size: 1rem;\n    padding: 0 3px;\n    background-color: #eee;\n  }\n\n  dd,\n  ul {\n    margin-left: 0;\n    padding-left: 25px;\n  }\n"])), fontSans, fontMono);
function Link(props) {
  return (
    // eslint-disable-next-line jsx-a11y/anchor-has-content
    react.jsx("a", _extends({}, props, {
      css: {
        color: '#0076ff',
        textDecoration: 'none',
        ':hover': {
...
function AboutLogoImage(props) {
  ...
  return react.jsx("img", _extends({}, props, {
    css: {
      maxWidth: '90%'
    }
  }));
...
function Stats(_ref2) {
  ...
  let since = parse(totals.since);
  let until = parse(totals.until);
  return react.jsx("p", null, "From ", react.jsx("strong", null, format(since, 'MMM D')), " to", ' ', react.jsx("strong", null, format(until, 'MMM D')), " unpkg served", ' ', react.jsx("strong", null, formatNumber(totals.requests.all)), " requests and a total of ", react.jsx("strong", null, formatBytes(totals.bandwidth.all)), " of data to", ' ', react.jsx("strong", null, formatNumber(totals.uniques.all)), " unique visitors,", ' ', react.jsx("strong", null, formatPercent(totals.requests.cached / totals.requests.all, 2), "%"), ' ', "of which were served from the cache.");
}
function App() {
  let [stats, setStats] = React.useState(typeof window === 'object' && window.localStorage && window.localStorage.savedStats ? JSON.parse(window.localStorage.savedStats) : null);
  ...
  React.useEffect(() => {
    fetch('/api/stats?period=last-month').then(res => res.json()).then(setStats);
  }, []);
  return react.jsx(React.Fragment, null, react.jsx(react.Global, {
    styles: globalStyles
  }), react.jsx("div", {
  ...
  }, react.jsx("header", null, react.jsx("h1", {
    css: {
      textAlign: 'center',
      fontSize: '4.5em',
      letterSpacing: '0.05em',
  ...
  }, "UNPKG"), react.jsx("p", null, "unpkg is a fast, global content delivery network for everything on", ' ', react.jsx(Link, {
    href: "https://www.npmjs.com/"
  }, "npm"), ". Use it to quickly and easily load any file from any package using a URL like:"), react.jsx("div", {
    css: {
      textAlign: 'center',
      backgroundColor: '#eee',
      margin: '2em 0',
  ...
  }, "unpkg.com/:package@:version/:file"), hasStats && react.jsx(Stats, {
    data: stats
  })), react.jsx("h3", {
    css: {
      fontSize: '1.6em'
    ...
    id: "examples"
  }, "Examples"), react.jsx("p", null, "Using a fixed version:"), react.jsx("ul", null, react.jsx("li", null, react.jsx(Link, {
    href: "/react@16.7.0/umd/react.production.min.js"
  }, "unpkg.com/react@16.7.0/umd/react.production.min.js")), react.jsx("li", null, react.jsx(Link, {
    href: "/react-dom@16.7.0/umd/react-dom.production.min.js"
  }, "unpkg.com/react-dom@16.7.0/umd/react-dom.production.min.js"))), react.jsx("p", null, "You may also use a", ' ', react.jsx(Link, {
    href: "https://docs.npmjs.com/about-semantic-versioning"
  }, "semver range"), ' ', "or a ", react.jsx(Link, {
    href: "https://docs.npmjs.com/cli/dist-tag"
  }, "tag"), ' ', "instead of a fixed version number, or omit the version/tag entirely to use the ", react.jsx("code", null, "latest"), " tag."), react.jsx("ul", null, react.jsx("li", null, react.jsx(Link, {
    href: "/react@^16/umd/react.production.min.js"
  }, "unpkg.com/react@^16/umd/react.production.min.js")), react.jsx("li", null, react.jsx(Link, {
    href: "/react/umd/react.production.min.js"
  }, "unpkg.com/react/umd/react.production.min.js"))), react.jsx("p", null, "If you omit the file path (i.e. use a \u201Cbare\u201D URL), unpkg will serve the file specified by the ", react.jsx("code", null, "unpkg"), " field in", ' ', react.jsx("code", null, "package.json"), ", or fall back to ", react.jsx("code", null, "main"), "."), react.jsx("ul", null, react.jsx("li", null, react.jsx(Link, {
    href: "/jquery"
  }, "unpkg.com/jquery")), react.jsx("li", null, react.jsx(Link, {
    href: "/three"
  }, "unpkg.com/three"))), react.jsx("p", null, "Append a ", react.jsx("code", null, "/"), " at the end of a URL to view a listing of all the files in a package."), react.jsx("ul", null, react.jsx("li", null, react.jsx(Link, {
    href: "/react/"
  }, "unpkg.com/react/")), react.jsx("li", null, react.jsx(Link, {
    href: "/react-router/"
  }, "unpkg.com/react-router/"))), react.jsx("h3", {
    css: {
      fontSize: '1.6em'
    },
    id: "query-params"
  }, "Query Parameters"), react.jsx("dl", null, react.jsx("dt", null, react.jsx("code", null, "?meta")), react.jsx("dd", null, "Return metadata about any file in a package as JSON (e.g.", react.jsx("code", null, "/any/file?meta"), ")"), react.jsx("dt", null, react.jsx("code", null, "?module")), react.jsx("dd", null, "Expands all", ' ', react.jsx(Link, {
    href: "https://html.spec.whatwg.org/multipage/webappapis.html#resolve-a-module-specifier"
  }, "\u201Cbare\u201D ", react.jsx("code", null, "import"), " specifiers"), ' ', "in JavaScript modules to unpkg URLs. This feature is", ' ', react.jsx("em", null, "very experimental"))), react.jsx("h3", {
    css: {
      fontSize: '1.6em'
    },
    id: "cache-behavior"
  }, "Cache Behavior"), react.jsx("p", null, "The CDN caches files based on their permanent URL, which includes the npm package version. This works because npm does not allow package authors to overwrite a package that has already been published with a different one at the same version number."), react.jsx("p", null, "Browsers are instructed (via the ", react.jsx("code", null, "Cache-Control"), " header) to cache assets indefinitely (1 year)."), react.jsx("p", null, "URLs that do not specify a package version number redirect to one that does. This is the ", react.jsx("code", null, "latest"), " version when no version is specified, or the ", react.jsx("code", null, "maxSatisfying"), " version when a", ' ', react.jsx(Link, {
    href: "https://github.com/npm/node-semver"
  }, "semver version"), ' ', "is given. Redirects are cached for 10 minutes at the CDN, 1 minute in browsers."), react.jsx("p", null, "If you want users to be able to use the latest version when you cut a new release, the best policy is to put the version number in the URL directly in your installation instructions. This will also load more quickly because we won't have to resolve the latest version and redirect them."), react.jsx("h3", {
    css: {
      fontSize: '1.6em'
    },
    id: "workflow"
  }, "Workflow"), react.jsx("p", null, "For npm package authors, unpkg relieves the burden of publishing your code to a CDN in addition to the npm registry. All you need to do is include your", ' ', react.jsx(Link, {
    href: "https://github.com/umdjs/umd"
  }, "UMD"), " build in your npm package (not your repo, that's different!)."), react.jsx("p", null, "You can do this easily using the following setup:"), react.jsx("ul", null, react.jsx("li", null, "Add the ", react.jsx("code", null, "umd"), " (or ", react.jsx("code", null, "dist"), ") directory to your", ' ', react.jsx("code", null, ".gitignore"), " file"), react.jsx("li", null, "Add the ", react.jsx("code", null, "umd"), " directory to your", ' ', react.jsx(Link, {
    href: "https://docs.npmjs.com/files/package.json#files"
  }, "files array"), ' ', "in ", react.jsx("code", null, "package.json")), react.jsx("li", null, "Use a build script to generate your UMD build in the", ' ', react.jsx("code", null, "umd"), " directory when you publish")), react.jsx("p", null, "That's it! Now when you ", react.jsx("code", null, "npm publish"), " you'll have a version available on unpkg as well."), react.jsx("h3", {
    css: {
      fontSize: '1.6em'
    },
    id: "about"
  }, "About"), react.jsx("p", null, "unpkg is an", ' ', react.jsx(Link, {
    href: "https://github.com/mjackson/unpkg"
  }, "open source"), ' ', "project built and maintained by", ' ', react.jsx(Link, {
    href: "https://twitter.com/mjackson"
  }, "Michael Jackson"), ". unpkg is not affiliated with or supported by npm, Inc. in any way. Please do not contact npm for help with unpkg. Instead, please reach out to ", react.jsx(Link, {
    href: "https://twitter.com/unpkg"
  }, "@unpkg"), " with any questions or concerns."), react.jsx("p", null, "The unpkg CDN is powered by", ' ', react.jsx(Link, {
    href: "https://www.cloudflare.com"
  }, "Cloudflare"), ", one of the world's largest and fastest cloud network platforms.", ' ', hasStats && react.jsx("span", null, "In the past month, Cloudflare served over", ' ', react.jsx("strong", null, formatBytes(stats.totals.bandwidth.all)), " to", ' ', react.jsx("strong", null, formatNumber(stats.totals.uniques.all)), " unique unpkg users all over the world.")), react.jsx("div", {
    css: {
      margin: '4em 0',
      display: 'flex',
      justifyContent: 'center'
    }
  }, react.jsx(AboutLogo, null, react.jsx("a", {
    href: "https://www.cloudflare.com"
  }, react.jsx(AboutLogoImage, {
    alt: "Cloudflare",
    src: CloudflareLogo,
    height: "100"
  })))), react.jsx("p", null, "The origin server runs on auto-scaling infrastructure provided by", ' ', react.jsx(Link, {
    href: "https://fly.io/"
  }, "Fly.io"), ". The app servers run in 17 cities around the world, and come and go based on active requests."), react.jsx("div", {
    css: {
      margin: '4em 0 0',
      display: 'flex',
      justifyContent: 'center'
  ...
  }, react.jsx("p", null, react.jsx("span", null, "Build: ", buildId)), react.jsx("p", null, react.jsx("span", null, "\xA9 ", new Date().getFullYear(), " UNPKG")), react.jsx("p", {
    css: {
      fontSize: '1.5rem'
    }
  }, react.jsx("a", {
  ...
  }, react.jsx(TwitterIcon, null)), react.jsx("a", {
    href: "https://github.com/mjackson/unpkg",
    css: {
      color: '#aaa',
      display: 'inline-block',
...
function serveMainPage(req, res) {
  const content = createHTML(server$1.renderToString(React.createElement(App)));
...
if (process.env.NODE_ENV !== 'production' && process.env.ENABLE_CLOUDFLARE === '1') {
  if (!cloudflareEmail) {
...
function getJSON(path, headers) {
  return get(path, headers).then(res => {
    return res.json();
  }).then(data => {
    if (!data.success) {
...
function serveStats(req, res) {
  if (process.env.ENABLE_CLOUDFLARE !== '1') return res.send({
    error: 'disabled'
  });
  let since, until;
  if (req.query.period) {
...
var findEntry$1 = asyncHandler(findEntry);
...
function createServer() {
  return createApp(app => {
    ...
    const moduleApp = createApp(app => {
      app.enable('strict routing');
      app.get('*', allowQuery('module'), validatePackagePathname, validatePackageName, validatePackageVersion, validateFilename, findEntry$1, serveModule);
    });
    app.use((req, res, next) => {
      if (req.query.module != null) {
        moduleApp(req, res);
    ...
    app.get('*', noQuery(), validatePackagePathname, validatePackageName, validatePackageVersion, validateFilename, findEntry$1, serveFile);
  });
}
